...
namespace TestApp
{
    public sealed partial class ToolkitImageExPage
    {
        private readonly Stopwatch _stopwatch;
        private readonly DispatcherTimer _timer;

        public ToolkitImageExPage()
        {
            InitializeComponent();
        ...
        private void ToolkitImageExPage_Loaded(object sender, RoutedEventArgs e)
        {
            _stopwatch.Stop();
        ...
        private void ToolkitImageExPage_Unloaded(object sender, RoutedEventArgs e)
        {
            _timer.Stop();
        }
    }
